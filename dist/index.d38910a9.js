...
var _getRandomThrow = require('./get-random-throw');
var _didUserWin = require('./did-user-win');
...
button.addEventListener('click', () => {
  ...
  const comp = _getRandomThrow.getRandomThrow();
  compThrow.textContent = comp;
  const gameOutcome = _didUserWin.didUserWin(user, comp);
  if (gameOutcome === 'win') {
    wins++;
...
},{"./get-random-throw":"6ER4N","./did-user-win":"83YZY"}],"6ER4N":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "getRandomThrow", function () {
...
},{}],"83YZY":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "didUserWin", function () {
  return didUserWin;
});
function didUserWin(userInput, compInput) {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["1YFLS","5e1eZ"], "5e1eZ", "parcelRequire783b")
